    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button onclick="javascript:document.getElementById('notice').pause();" type="button" class="btn btn-default"
...
<script>
    ...
    if ("WebSocket" in window) {
        websocket = new WebSocket('ws://ws.mkmonkey.com/sell/webSocket');
    } else {
        alert('浏览器不支持');
    }
